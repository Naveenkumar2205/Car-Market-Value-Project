...
def results():
    ...
    cursor = db.cursor()          #It is used to make the connection for executing SQL queries
    if mileage:
    ...
    return render_template('results.html', market_price=round(avg_price, -1), listings=listings)
